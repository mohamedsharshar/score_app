...
<body class="font-sans antialiased">
    ...
    <div class="p-6 lg:p-8 bg-white border-b border-gray-200 iscore-bg text-white">
        <div class="flex items-center">
            ...
            <svg class="h-12 w-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M12 8c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3zm0 0c-2.761 0-5 2.239-5 5s2.239 5 5 5 5-2.239 5-5-2.239-5-5-5zm0 0V4m0 0c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8z" />
            </svg>
        ...
        <p class="mt-6 text-gray-200 leading-relaxed">
            iScore is your personal credit score companion, designed to help you understand and improve your financial
            health. By analyzing key factors like payment history, debt levels, credit history, and account diversity,
            iScore calculates a comprehensive credit score (0–850) tailored to your financial profile. Track your
            progress, export reports, and follow expert tips to boost your creditworthiness.
        </p>
        <!-- Theme Toggle -->
    ...
    <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow card-hover">
            ...
            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                Input your financial details, such as payment history, debt, and credit age, to calculate your
                personalized iScore. See how your financial habits impact your credit health.
            </p>
        ...
        <div class="bg-white p-6 rounded-lg shadow card-hover">
            <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M2.458 12C3.732 7.943 7.523 5.25 12 5.25c4.478 0 8.268 2.693 9.542 6.75a9.967 9.967 0 01-1.363 2.727m-2.079 2.197A9.961 9.961 0 0112 18.75a9.961 9.961 0 01-6.1-2.076" />
                </svg>
                <h2 class="ms-3 text-xl font-semibold text-gray-900">
                    استعراض معلومات العميل
                </h2>
            </div>
            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                ابحث عن العملاء بالاسم واستعرض جميع بياناتهم المخزنة في قاعدة بيانات iScore.
            </p>
            <p class="mt-4 text-sm">
        ...
        <div class="bg-white p-6 rounded-lg shadow card-hover">
            <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    class="size-6 stroke-gray-400">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5m.75-9l3-3 2.148 2.148A2.25 2.25 0 0116.5 7.5h1.125" />
                </svg>
                <h2 class="ms-3 text-xl font-semibold text-gray-900">
                    View Score History
                </h2>
            ...
            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                Track your credit score progress over time with a detailed history of your iScore calculations.
        ...
        <div class="bg-white p-6 rounded-lg shadow card-hover">
            ...
            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                Discover actionable advice to boost your iScore, from maintaining timely payments to optimizing credit
                utilization and diversifying your credit mix.
            </p>
            <p class="mt-4 text-sm">
        ...
        <div class="bg-white p-6 rounded-lg shadow card-hover">
            ...
            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                Generate a professional PDF report of your latest iScore, including a detailed breakdown of contributing
                factors and personalized improvement tips.
            </p>
            <p class="mt-4 text-sm">
    ...
    <script>
        ...
        themeToggle.addEventListener('click', () => {
            ...
            themeToggle.textContent = document.body.classList.contains('dark') ? 'Toggle Light Mode' :
                'Toggle Dark Mode';
        });
